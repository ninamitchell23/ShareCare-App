...
class VolunteerWidget extends StatelessWidget {
  const VolunteerWidget({super.key, required this.title, required this.image, required this.description, required this.time, this.onTap});
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      ReusableText(text: "🌍", style: appStyle(12, kPrimary, FontWeight.w500)),
                    ],
                  ),
